...
const Resume = () => {
  return (
    <div>
      ...
      <p className='text-lg text-gray-500' data-aos="fade-right" data-aos-duration="1000">
        You can download my resume and CV here.
      </p>
      <div className='mt-10 flex gap-4 flex-wrap justify-center sm:justify-start' data-aos="fade-right" data-aos-duration="1000">
